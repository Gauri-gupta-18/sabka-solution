...
export default function DashboardOverview() {
  ...
  const citizenStats = [
    { title: "Reports Submitted", value: "24", icon: <FileText className="h-5 w-5 text-blue-500" /> },
    { title: "Issues Resolved", value: "18", icon: <CheckCircle2 className="h-5 w-5 text-emerald-500" /> },
    { title: "Trust Score", value: "860", icon: <Award className="h-5 w-5 text-amber-500" /> },
    { title: "Citizen Rank", value: "Top 12%", icon: <TrendingUp className="h-5 w-5 text-primary" /> },
  ];
  ...
  const authorityStats = [
    ...
    { title: "Avg. Resolution", value: "3.2 Days", icon: <Clock className="h-5 w-5 text-blue-500" /> },
    { title: "Resolved This Week", value: "384", icon: <CheckCircle2 className="h-5 w-5 text-emerald-500" /> },
  ];
